...
export default function SignUpClient() {
  ...
  useEffect(() => {
    ...
    const messageByCode: Record<string, string> = {
      google_not_configured: 'Cadastro com Google não está configurado. Fale com o suporte.',
    ...
    setError(messageByCode[oauthError] || 'Erro ao autenticar.')
  }, [searchParams])
    ...
    >
      ...
      <Card className="w-full max-w-md relative z-10 shadow-2xl">
        <CardHeader>
          ...
          <CardDescription>Crie sua conta para começar a criar eventos</CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
